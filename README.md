...
- [x] **Itens Pré-cadastrados:** Lista inicia com produtos de exemplo.
- [x] **Checkbox Funcional:** Marcar itens como concluídos (risca + fade).
...
- [x] **Design Responsivo:** Perfeito em desktop, tablet e mobile.
...
1. **Clone o repositório:**
   ```bash
   git clone https://github.com/rodrigomscmontenegro/projeto-compras.git
   ```
...
├── style.css        # Estilização com variáveis CSS e animações
├── scripts.js       # Lógica completa (Storage, Drag&Drop, DOM)
└── assets/          # Assets visuais (Logo, ícones de lixeira e alerta)
```

---

**Desenvolvido com 💜 por [Rodrigo Montenegro](https://github.com/rodrigomscmontenegro)**